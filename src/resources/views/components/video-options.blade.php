            ...
            <div class="col-md-12">
                <div class="video-container">
                    <video id="player" playsinline controls poster="{{ $video->thumb_url }}">
                        <source src="{{ $video->original_video_link }}" type="application/x-mpegURL" />
                    </video>
            ...
            @default
                <div id="drag-drop-area">
                    ...
                    <div id="existing-videos-panel" class="existing-videos-panel">
                        <div id="existing-breadcrumb"
                            style="padding: 12px 20px; border-bottom: 1px solid #e9ecef; display: none;">
